...
* @see https://v0.dev/t/V6I4QZ8RA4C
    ...
    <div className="flex h-screen flex-col">
      ...
      <main className="flex-1 bg-gray-100 dark:bg-gray-800">
        <div className="container mx-auto py-8">
          <div className="flex h-[80vh] max-h-[80vh] flex-col rounded-lg border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-gray-950 dark:border-gray-800">
